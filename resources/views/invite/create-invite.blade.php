                ...
                <div class=" flex p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    <div>
                        <p class="mt-1 text-xl text-gray-600 dark:text-gray-400">
                            Olá <span class="font-semibold text-gray-800">{{$user->userName}}</span>, a empresa <span
                                class="font-semibold text-gray-800">{{$freela->company->companyName}}</span> está te convidando
                            para um freela.
                        </p>
