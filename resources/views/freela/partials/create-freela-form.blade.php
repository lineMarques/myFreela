                ...
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800  sm:rounded-lg">
                    ...
                    <div class="mt-4">
                        ...
                        <x-select name="cargo" id="cargo">
                            <option value="auxCozinha" {{old('jobTitle')==='auxCozinha' ? 'selected' : '' }}>Auxiliar de Cozinha</option>
                            <option value="chapeiro" {{old('jobTitle')==='chapeiro' ? 'selected' : '' }}>Chapeiro</option>
                            <option value="cozinheiro" {{old('jobTitle')==='cozinheiro' ? 'selected' : '' }}>Cozinheiro</option>
                            <option value="lavacao" {{old('jobTitle')==='lavacao' ? 'selected' : '' }}>Lavação</option>
                            <option value="sushiman" {{old('jobTitle')==='sushiman' ? 'selected' : '' }}>Sushiman</option>
                            <option value="pizzaiolo" {{old('jobTitle')==='pizzaiolo' ? 'selected' : '' }}>pizzaiolo</option>
                        </x-select>
