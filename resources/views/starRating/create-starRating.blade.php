        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class=" flex p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    <form action="{{route('stars.store',['user_id'=>$user->id, 'evaluator_user_id' => $maneger->id,])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div>
                            <p class="mt-1 text-2xl text-gray-600 dark:text-gray-400">
                                Nos ajude a escolher os melhores freelas para você. Como {{$user->name}} se saiu?
                            </p>
