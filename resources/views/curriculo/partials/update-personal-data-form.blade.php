<section>
    ...
    <div class="mt-4">
        ...
        <x-text-input id="cpf" class="block mt-1" type="text" name="cpf" :value="old('cpf',$user->cpf)"
    ...
    <div class="mt-4">
        ...
        <x-text-input id="age" class="block mt-1" type="text" name="age" :value="old('age', $user->age)"
